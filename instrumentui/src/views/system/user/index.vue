<template>
  <div class="app-container">
    <el-row :gutter="20">
      <!--部门数据-->
      <el-col v-if="deptOpen" :span="4" :xs="24">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="部门" align="center" key="deptName" prop="dept.deptName" v-if="deptOpen" :show-overflow-tooltip="true" />
