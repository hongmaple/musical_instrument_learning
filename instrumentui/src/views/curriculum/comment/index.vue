          ...
          <div class="content">
            <div style="display: flex;justify-content: space-between;width: 100%">
              <div class="nkname">
                ...
                <span class="rp">|</span>
                <span class="rp">查看课程：</span>
                <span class="blog" @click="getBlogInfo(mes)">{{mes.title}}</span>
              </div>
              <div class="op">
...
import { listComment, getComment, delComment, addComment, updateComment } from "@/api/music/curriculumComment";
import {
    Loading
  } from 'element-ui';
