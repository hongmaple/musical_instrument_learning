...
<script>
  ...
  import {
    curriculumListComment,
    curriculumAddComment,
  } from "@/api/music/curriculumComment"
    ...
    data() {
      return {
        ...
        queryParams: {
          ...
          content: null,
          type: null,
          curriculumId: this.$route.query.cId,
          userId: null,
          delFlag: null,
          createBy: null,
        },
    ...
    methods: {
      ...
      publish() {
        ...
        this.$refs.messageFormRef.validate(async valid => {
          ...
          curriculumAddComment(this.messageForm).then(response => {
      ...
      async getMessageList() {
        ...
        curriculumListComment(this.queryParams).then(response => {
