...
<script>
  ...
  import {
    addcurriculumCommentLike,
    delcurriculumCommentLike,
  ...
  export default {
    ...
    methods: {
      ...
      addCommentLike(item){
        ...
        addcurriculumCommentLike(this.commentLikeForm).then(response => {
          this.reset();
        });
      },
      /**
      ...
      delCommentLike(item){
        ...
        delcurriculumCommentLike(this.commentLikeForm).then(response => {
          this.reset();
        });
      },
      /**
