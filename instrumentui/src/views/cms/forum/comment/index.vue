  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="标题" prop="forumTitle">
        <el-input v-model="queryParams.forumTitle" placeholder="请输入标题" clearable size="small"
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item>
    ...
    <el-table v-loading="loading" :data="commentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="被评论者id，可以是人、项目、资源" align="center" prop="curriculumId" />
          ...
          <div class="content">
            <div style="display: flex;justify-content: space-between;width: 100%">
              <div class="nkname">
                ...
                <span class="rp">|</span>
                <span class="rp">查看论坛：</span>
                <span class="blog" @click="getBlogInfo(mes)">{{mes.forumTitle}}</span>
              </div>
              <div class="op">
...
import { listComment, getComment, delComment, addComment, updateComment } from "@/api/cms/forumComment";
import {
    Loading
  } from 'element-ui';
...
export default {
  ...
  methods: {
    ...
    handleAdd(mes) {
      ...
      this.form.curriculumId = mes.curriculumId
      this.form.type = '1'
