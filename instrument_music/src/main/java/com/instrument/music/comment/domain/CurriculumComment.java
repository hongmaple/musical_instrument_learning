package com.instrument.music.comment.domain;
 ...
 * @date 2022-01-21
 */
public class CurriculumComment extends BaseEntity
{
    ...
    /** 回复 */
    private List<CurriculumComment> children;
    ...
    public List<CurriculumComment> getChildren() {
        return children;
    }

    public void setChildren(List<CurriculumComment> children) {
