package com.instrument.cms.comment.service.impl;

import java.util.ArrayList;
import java.util.List;

import com.instrument.cms.blog.domain.CmsBlog;
import com.instrument.cms.blog.mapper.CmsBlogMapper;
import com.instrument.cms.comment.domain.CmsCommentLike;
import com.instrument.cms.comment.mapper.CmsCommentLikeMapper;
...
import com.instrument.cms.comment.mapper.CmsCommentMapper;
import com.instrument.cms.comment.domain.CmsComment;
import com.instrument.cms.comment.service.ICmsCommentService;
    ...
    public List<CmsComment> selectCmsCommentList(CmsComment cmsComment)
    {
        ...
        for (CmsComment comment : cmsCommentList) {
            ...
            if (blogId!=null){
                ...
                if(ObjectUtils.isNotEmpty(blog)) {
